# Ladowanie wymaganych bibliotek
rm(list=ls())
...
query <- "year:2000-2022" # Ograniczenie wyszukiwania do utworow od 2000 do 2022
limit <- 50 # Liczba utworow na jedno zadanie API 
n <- 10000 # Calkowita liczba identyfikator?w utwor?w do pobrania
